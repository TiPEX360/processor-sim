...
public:
    ...
    void update();
    ReorderBuffer() {};
    ReorderBuffer(BPB *branchBuffer, std::deque<Instr> *nextFetched, bool *halt, std::array<ExecutionUnit *, EXEC_COUNT> *EUs, Register *nextRF, int32_t *nextMEM, std::array<ReservationStation, RS_COUNT> *RSs);
};